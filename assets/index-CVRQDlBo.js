import{p as j,o as u,c as p,e as T,m as a,B as _,E as O,v as g,s as F,r as b,l as H,t as N,R as D,H as A,J as K,O as U,f as x,w as W,g as w,n as I,q as Z,aF as R,aG as q,aH as G,T as J}from"./index-CcUtrgh4.js";function f(...t){if(t){let n=[];for(let o=0;o<t.length;o++){let e=t[o];if(!e)continue;let i=typeof e;if(i==="string"||i==="number")n.push(e);else if(i==="object"){let r=Array.isArray(e)?[f(...e)]:Object.entries(e).map(([l,s])=>s?l:void 0);n=r.length?n.concat(r.filter(l=>!!l)):n}}return n.join(" ").trim()}}var V={name:"SpinnerIcon",extends:j};function Q(t){return nt(t)||tt(t)||Y(t)||X()}function X(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
